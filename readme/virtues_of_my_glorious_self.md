...
i confuse myself. high priority truths with noisy truths.
    ...
    i complicate when simple is enough.
i try to do it all by my own self without help. so i get stuck for an eternity...
    i lack confidence. i overestimate or underestimate. i hallucinate.
    i do not simulate my own future properly.
i am NOT consistent. i jump between things. starting new things allways. never making things reach completion.
i lack realistic estimate of how much energy it will take for me to learn and revisit 3 times.
    i simply do not remember usefull things, i need revision.
    though i know what exactly i need to learn and even how i need to learn it, i keep ignoring it.
    IF i do not know how to get it done;
    THEN i think i can NOT get it done.
