...
/*if i do not have to do a certain thing, then i feel lucky.
why? because i have a belief in it being impossible.
why do i have a belief in it being impossible? i do not know!*/

KNOW THAT I AM ALLREADY A FAILURE AND NOTHING I DO CAN EVER CHANGE _THAT_.
...
### i am afraid of ...
    ...
    knowing what i want?
    a person who knows of the way i am just a pretender full of shame?
    knowing that i am incapable of knowing what i want?
    knwoing that it is not doable?
    not being able to find what i missed?
    knowing that there is something worth knowing in it?
    coming to know of more than 1 AIMs?
    failing to find that which i assume?
...
understanding the WHY is the key.
an ocean of properties...
how to do the perception of why it is the way it is? - good question.
    1. need to see all the things at play with a zoom-in and zoom-out functionality.
    2. creating ways based on conclusions based on what the self gets to see.
...
by writing 1 IF-THEN;
i am writing INFINITE IF-THEN...


QUOTES
"wow."
"please do not request me to do that. oh no! i am required to do that only..."
...
"it must be easy only. how hard can it be?"
"i must be missing a certain simple case."
"let me see that which can be known by me!"
"oh my God! i am getting new usuefull ideas!! please let me wait and think it all through."
...
where was i being wrong about this?
...
what am i missing in here? how on EARTH have i come to miss to consider it?
did this change between that1 and that2?
what does it even mean?
what do i think i do not know about that?
can i extract 1 more usefull truth?
so what?
it is unknowable to me; but why?
...
PROPERTY
    ...
    (how to create properties of things at play?
    how to get the perception of a property done?
    what are various types of properties?)

    (INFINITE)properties of problems...remember TAO?
        what i can get done in Reality is a property OF my own self.


EXCEPTION
    an exception is that which does not satisfy a property.
    an exception is not just an exception.
    it is something that my self completely failed to consider.
    it is an exception to how i check i do not miss ANY thing.
    it is an exception to my thinking at MANY LEVELS...
    perception of an exception?
...
fix is an inversion of the problem.
...
(how does the self come to do the) perception of [IF this; THEN that.](here is the why!)
a sentence of 10 words = what words to use + how to rearrange the words.

wherever there is profit, therein lies insanity.
insanity is that which confuses 
    a belief in justice.
    pleasure.
    power.
insanity is dangerous.

class generic_thing_type {
    property_of_generic_thing_type 
}
a thing can be and not be in existence.
a thing can have very many properties.
a thing has properties with respect to other things.
properties can be created with created things.
a property has a YES/NO answer.
specific eyes are required to see these properties.
...
why do i have a belief in the existence of "silly" miss-takes, as something not worth my attention? i do not know.
why do i not know how to find out the miss-take i must be making? i do not know.
why do i think "it is profitable to ignore the miss-takes i make."? i do not know.
why do i feel "i have done something special" each time i avert doing a miss-take? i do not know.
why do i continue even IF i know it is a miss-take? i do not know. 
why do i lose all hope in myself IF i do the perception of my self doing a miss-take in Reality? i do not know.
why do i put my hands near my mouth when i come to know of my miss-takes? i do not know.
...
why do i secretly desire innocent beings to commit miss-takes? i do not know.
why do i want to see innocent beings enjoy the good things i am deprived of? i do not know.
why do i not want to see innocent beings not commit the miss-takes i have? i do not know.
